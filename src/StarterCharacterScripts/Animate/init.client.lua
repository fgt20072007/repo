...
local UserSettings = UserGameSettings.Parent :: UserSettings
...
local humanoid = assert(character:FindFirstChildOfClass("Humanoid"), "No Humanoid object found for the Animate script to use!")
...
local baseRunSpeed = gameRules.RunWalkSpeed / 1.25
local baseWalkSpeed = gameRules.NormalWalkSpeed / 1.25
...
self.Defaults = {
	idle = {
		{ Id = "rbxassetid://17172918855", Weight = 10 },
	},
...
local function isFinite(n: number)
