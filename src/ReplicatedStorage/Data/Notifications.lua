...
return TableUtil.Lock({
	...
	BoxDelivery = {
		...
		MustEquip = {
			Type = 'Warning',
			Messages = {`Equip the box you want to deliver.`},
		},
		AlreadyCarrying = {
			Type = 'Warning',
			Messages = {`You can only carry one box at a time.`},
		},
		Delivered = {
			Type = 'Success',
			Messages = {'Delivery completed. You received ${cash}.'},
		},
	},
	...
	Tunnel = {
		...
		NotEnoughCash = {
			Type = 'Warning',
			Messages = {"You don't have enough cash. You need ${needed} more."},
		},
	},
	...
	AmmoBox = {
		Purchased = {
			Type = 'Success',
			Messages = {'Ammunition refilled for all your weapons.'},
		},
		NotEnoughCash = {
			Type = 'Warning',
			Messages = {"You don't have enough cash to refill ammo. You need ${needed} more."},
		},
		NoWeapons = {
			Type = 'Warning',
			Messages = {'You do not have any compatible weapons to refill.'},
		},
	},
