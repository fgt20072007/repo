return {
	...
	MockInStudio = false, -- Use a mocked version of a datastore (No saves)
	CurrentDatastoreVersion = "0.0.7", -- Datastore version usefull for changing datastores

	EventId = "", -- Event id on the side

	SpawnOrentationOffset = -90, -- Offset of the spawn orientation of entities
	GrabAnimationId = 82122573399455, -- Animation id for grabbbing
