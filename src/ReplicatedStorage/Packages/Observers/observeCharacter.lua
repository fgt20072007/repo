...
type CallbackReturnFn = (player: Player, character: Model) -> () -> ()
type CallbackReturnVoid = (player: Player, character: Model) -> ()
type Callback = CallbackReturnFn | CallbackReturnVoid
