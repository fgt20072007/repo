...
type CallbackReturnFn<T> = (instance: T) -> () -> ()
type CallbackReturnVoid<T> = (instance: T) -> ()
type Callback<T> = CallbackReturnFn<T> | CallbackReturnVoid<T>
