return {
	...
	IdleTorque = 500, -- n-m [Engine idle torque]
	...
	Gravity = 196.2, -- studs/s2 [Gravity for the vehicle body]

	Fuel = {
		Capacity = 100, -- liters [Max fuel capacity for this vehicle]
		ConsumptionPerStud = 0.025, -- liters/stud [Fuel burned while driving]
	},
}