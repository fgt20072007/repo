...
--------------
	...
	--// Basic Luau Info
		...
		settings.Ranks["Admins"] = {
			Level = 200
			Users = {
				"Bobjenkins123", "Bobjenkins123:1234567", 1234567, "Group:7463213:234", "Item:1237465"
			}
		}


		If I wanted to make it so rank 134 in group 1029934 and BobJenkins123 had mod admin I would do
		settings.Ranks["Moderators"] = {
			Level = 100
			Users = {
				"Group:1029943:134", "BobJenkins123"
			}
		}
...
settings.DataStore = "SourJelly"					 -- DataStore the script will use for saving data; Changing this will lose any saved data
settings.DataStoreKey = "Alamomos#15123"			 -- CHANGE THIS TO ANYTHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
		...
		Format Example:
			settings.Ranks = {
				["Moderators"] = {
					Level = 100;
					Users = {
						"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID"; "GamePass:GamePassID"; "Subscription:SubscriptionId";
					}
				}
			}
...
settings.Ranks = {
	...
	["Creators"] = {
		...
		Users = {"Group:35825611:254", "alamo_as:3361245195", "xSphes:3470932754", "Servimsa:7674888408"
...
settings.Permissions = {"!avataritem:Moderators";"!fire:Moderators";"!light:Moderators";"!particle:Moderators";"!sparkles:Moderators";"team:Admins";"incognito:Admins";"changestat:Creators";"add:Creators";"brazil:Creators";"nuke:Creators";"fling:Creators";"change:Creators";"mod:Creators";"moderator:Creators";"admin:Creators";"permadmin:Creators";"permmod:Creators";"tempmod:Creators";"tempadmin:Creators";"administrator:Creators";"explore:Creators";"s:Creators";"zawarudo:Creators";"globalban:Admins";"gameban:Admins";"timeban:Admins";"insert:Creators";"ins:Creators","health:Creators"
...
settings.BanMessage = "You are permanently banned from the game, join the communications server for more information"				-- Message shown to banned users upon kick
settings.LockMessage = "Server Locked, join another server"	-- Message shown to people when they are kicked while the game is :slocked
settings.SystemTitle = "El Paso, Texas"		-- Title to display in :sm and :bc
...
settings.ReJail = true			           -- If true then when a player rejoins they'll go back into jail. Or if the moderator leaves everybody gets unjailed
...
settings.G_Access_Key = "aroxiza"	-- Key required to use the _G access API; Example_Key will not work for obvious reasons
