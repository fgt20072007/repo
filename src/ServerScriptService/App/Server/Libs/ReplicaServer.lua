...
local sharedUtil = appShared:WaitForChild("Util")

local RateLimit = require(sharedUtil:WaitForChild("RateLimit"))
local Remote = require(sharedUtil:WaitForChild("Remote"))
local Signal = require(sharedUtil:WaitForChild("Signal"))
local Maid = require(sharedUtil:WaitForChild("Maid"))
